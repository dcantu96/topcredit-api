...
RSpec.describe Payments, type: :lib do
  describe "get next payment date" do
    it "returns the end of the month for monthly term if dispersion is at the beginning of the month" do
      result =
        Payments.get_next_payment_date(DateTime.parse("2024-01-05"), "monthly")
      expect(result).to eq(DateTime.parse("2024-01-31").at_noon)
    end

    it "advances correctly when duration type is monthly and first discount date is the last day of the month" do
      result =
        Payments.get_next_payment_date(DateTime.parse("2024-01-31"), "monthly")
      expect(result).to eq(DateTime.parse("2024-02-29").at_noon)
      result =
        Payments.get_next_payment_date(DateTime.parse("2024-02-29"), "monthly")
      expect(result).to eq(DateTime.parse("2024-03-31").at_noon)
      result =
        Payments.get_next_payment_date(DateTime.parse("2024-03-31"), "monthly")
      expect(result).to eq(DateTime.parse("2024-04-30").at_noon)
      result =
        Payments.get_next_payment_date(DateTime.parse("2024-04-30"), "monthly")
      expect(result).to eq(DateTime.parse("2024-05-31").at_noon)
      result =
        Payments.get_next_payment_date(DateTime.parse("2024-05-31"), "monthly")
      expect(result).to eq(DateTime.parse("2024-06-30").at_noon)
      result =
        Payments.get_next_payment_date(DateTime.parse("2023-12-31"), "monthly")
      expect(result).to eq(DateTime.parse("2024-01-31").at_noon)
    end

    it "advances correctly when duration type is monthly and dispersion date is the 17th" do
      result =
        Payments.get_next_payment_date(DateTime.parse("2018-01-17"), "monthly")
      expect(result).to eq(DateTime.parse("2018-01-31").at_noon)
      result =
        Payments.get_next_payment_date(DateTime.parse("2018-01-31"), "monthly")
      expect(result).to eq(DateTime.parse("2018-02-28").at_noon)
      result =
        Payments.get_next_payment_date(DateTime.parse("2018-02-28"), "monthly")
      expect(result).to eq(DateTime.parse("2018-03-31").at_noon)
      result =
        Payments.get_next_payment_date(DateTime.parse("2018-03-31"), "monthly")
      expect(result).to eq(DateTime.parse("2018-04-30").at_noon)
      result =
        Payments.get_next_payment_date(DateTime.parse("2018-04-30"), "monthly")
      expect(result).to eq(DateTime.parse("2018-05-31").at_noon)
      result =
        Payments.get_next_payment_date(DateTime.parse("2018-05-31"), "monthly")
      expect(result).to eq(DateTime.parse("2018-06-30").at_noon)
    end

    it "advances to the correct day when duration type is bi-monthly and first discount date is the last day of the month" do
      result =
    ...
    it "advances to the correct day when duration type is bi-monthly and prev payment is the 4th" do
      result =
        Payments.get_next_payment_date(
    ...
    it "advances to the correct day when duration type is bi-monthly and prev payment is the 15th" do
      result =
        Payments.get_next_payment_date(
  ...
  describe "first expected payment date" do
    ...
    it "returns the correct first expected payment date for bi-monthly term" do
      result =
        Payments.first_expected_payment_date(
          DateTime.parse("2024-01-05"),
          "bi-monthly"
  ...
  describe "credit amount" do
    it "returns the correct credit amount" do
      result = Payments.credit_amount(1_000, 0.1, 12, "monthly")
      expect(result).to eq(1_055.04)
      result = Payments.credit_amount(500, 0.2, 12, "monthly")
      expect(result).to eq(555.84)
      result = Payments.credit_amount(100, 0.5, 12, "monthly")
      expect(result).to eq(129.12)
      result = Payments.credit_amount(36_268.06, 0.522, 12, "monthly")
      expect(result).to eq(47_319.84)
      result = Payments.credit_amount(34_177.21, 0.58, 18, "monthly")
  ...
  describe "calculate emi" do
    it "returns the correct emi" do
      result = Payments.emi(36_268.06, 0.522, 12, "monthly")
      expect(result).to eq(3_943.32)
      result = Payments.emi(34_177.21, 0.58, 18, "monthly")
      expect(result).to eq(2_885.78)
      result = Payments.emi(5_000.0, 0.58, 14, "monthly")
      expect(result).to eq(499.75)
      result = Payments.emi(36_268.06, 0.24, 24, "bi-monthly")
      expect(result).to eq(1_707.26)
    end
  end

  describe "max loan amount" do
    it "returns the correct maximum loan amount" do
      result = Payments.max_loan_amount(300, 0.3, 0.522, 7, "monthly")
