class Api::UserResource < JSONAPI::Resource
  attributes :first_name, :last_name, :email, :phone, :password, :employee_number,
             ...
             :proof_of_address_uploaded_at, :reason, :identity_document_status, :identity_document_rejection_reason,
             :bank_statement_status, :bank_statement_rejection_reason, :payroll_receipt_status,
             :payroll_receipt_rejection_reason, :proof_of_address_status, :proof_of_address_rejection_reason,
