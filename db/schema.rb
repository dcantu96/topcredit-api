...
ActiveRecord::Schema[7.1].define(version: 2025_02_22_002432) do
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.string "employee_salary_frequency", default: "bi-monthly", null: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["hr_company_id"], name: "index_users_on_hr_company_id"
  ...
  add_foreign_key "users", "companies", column: "hr_company_id"
